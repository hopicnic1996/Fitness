                ...
                <nav class="navbar-default navbar-static-top" role="navigation">
                    ...
                    <div class=" border-bottom">
                        ...
                        <div class="drop-men" >
                            <ul class=" nav_1">
                                <li class="dropdown">
                                    <a href="admin_menu.php" class="dropdown-toggle dropdown-at" data-toggle="dropdown"><span class=" name-caret"><?php echo $userm; ?></span><?php if ($csImage == null) { ?> <img src="./images/User/default.jpg" height="50"> <?php } else { ?><img src="./images/Customer/<?php echo $csImage ?>" height="50"> <?php } ?></a>
                                </li>
                                ...
                                <ul class="nav" id="side-menu">
                                    <li>
                                        ...
                                        <ul class="nav nav-second-level">
                                            <li><a href="detail_customer.php" class=" hvr-bounce-to-right"> <i class="fa fa-area-chart nav_icon"></i>Profile</a></li>
                                            <li><a href="change_password.php" class=" hvr-bounce-to-right"> <i class="fa fa-area-chart nav_icon"></i>Change password</a></li>
